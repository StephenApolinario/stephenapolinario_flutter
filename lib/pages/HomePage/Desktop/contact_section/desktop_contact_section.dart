...
import 'package:stephenapolinario_flutter/pages/HomePage/Desktop/contact_section/desktop_contact_section_painter.dart';
...
class _DesktopContactSectionState extends State<DesktopContactSection> {
  ...
  final double containerHeight = 800;
    ...
    return Stack(
      children: [
        Positioned(
          ...
          right: 0,
          left: 0,
          child: _contactSectionDivider(context),
        ),
  ...
  Form _contact(BuildContext context) {
    return Form(
      key: _formKey,
      child: Column(
  ...
  Column _socials(BuildContext context) {
    return Column(
      children: [
        SelectableText(
  ...
  Widget _contactSectionDivider(BuildContext context) {
    return CustomPaint(
      painter: ContactSectionPainter(
        size: MediaQuery.of(context).size,
        containerHeight: containerHeight,
        paddingTopContainer: paddingTopContainer,
      ),
    );
  }
}
